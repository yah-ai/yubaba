...
//!
//! Accepts preauth-key creation requests from yubaba, validates the request
...
/// from yubaba's operator-bridge registration path.
///
/// ```rust,ignore
...
impl HeadscaleMock {
    ...
    ///
    /// Pass this to `ServerState::with_headscale_url` to point yubaba at the
