...
//!
//! Accepts tunnel registration POSTs from yubaba, validates the request shape,
...
pub struct TunnelRegistration {
    ...
    pub hostname: String,
    /// Backend service URL yubaba passed, e.g. `"http://127.0.0.1:8080"`.
...
/// port and accepts tunnel registration requests from yubaba.
///
/// ```rust,ignore
...
impl CloudflaredMock {
    ...
    ///
    /// Pass this to `ServerState::with_cloudflared_url` to point yubaba at the
