...
//! no in-warden ledger is needed (R471-S1 verdict). This is the key difference
...
#[async_trait]
impl Constable for DockerRuntime {
...
/// `Restarting` flag — no in-warden ledger is needed (R471-S1 verdict).
