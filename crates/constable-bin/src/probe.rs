...
//! ## Decision
//!
//! Constable polls the [`Healthcheck`](workload_spec::Healthcheck) declared in
...
//! — see `.yah/docs/working/W154-warden-dual-runtime.md` §"Resolved decisions".
//!
//! ## Surface
//!
//! - [`ProbeTarget`] — per-workload data Constable retains across deploy:
...
use constable_proto::ProbeStatus;
use tokio::io::{AsyncReadExt, AsyncWriteExt};
use tokio::net::TcpStream;
use tokio::time::timeout;
use workload_spec::{HealthProbe, Healthcheck};

/// Per-workload probe configuration Constable retains across deploy.
///
...
/// [`ProbeStatus::Ready`] so Warden's admission logic doesn't have to special-
