...
//!
//! Linux's `pidfd_open(2)` gives Constable a stable, race-free handle to a
...
//! - [`PidfdReaper::recv`] is the consumer side — Constable's server reads
//!   events here and pushes them to Warden as
...
use constable_proto::{ExitStatus as WireExitStatus, WorkloadId};
use thiserror::Error;
use tokio::sync::mpsc;
